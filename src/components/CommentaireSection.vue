<template>
    <div class="w-full max-w-5xl mx-auto py-16">
        <h2 class="text-4xl font-bold mb-12 text-center text-[#1e3f29]">Espace commentaires</h2>
        <div class="flex items-center justify-center gap-4">
            <button 
                @click="prev" 
                :disabled="startIndex === 0"
                class="w-10 h-10 flex items-center justify-center rounded shadow text-[#1e3f29] font-bold disabled:opacity-50 transition hover:bg-[#e3efe7]"
            >
            ...
            <div class="flex gap-8 w-full justify-center">
                <div 
                    ...
                    :key="comment.id" 
                    :class="[
                        'rounded-xl shadow-lg p-8 w-80 flex flex-col items-start transition-all duration-300',
